...
const AddCommentOperate: ResourceOperations = {
	name: '添加留言',
	value: 'addComment',
	action: '添加留言',
	options: [
		...
		},
		{
			...
			required: true,
			description: '请求体 JSON 格式。必填参数：commentId (number), commentMsg (string), mentionUserIds (array)',
			typeOptions: {
...
export default AddCommentOperate;
